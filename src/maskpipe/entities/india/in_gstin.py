...
_CONTEXT_PATTERNS: list[ContextPattern] = [
    {"pattern": [{"LEMMA": {"IN": ["gstin", "gst"]}}], "score": 0.35},
    {"pattern": [{"LEMMA": "goods"}, {"LEMMA": "and"}, {"LEMMA": "services"}, {"LEMMA": "tax"}], "score": 0.35},
    {"pattern": [{"LEMMA": "tax"}, {"LEMMA": "identification"}], "score": 0.35},
    {"pattern": [{"LEMMA": "gst"}, {"LEMMA": "number"}], "score": 0.35},
    {"pattern": [{"LEMMA": "gst"}, {"LEMMA": "registration"}], "score": 0.35},
]
